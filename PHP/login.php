    ...
    if (mysqli_num_rows($result)) {
      ...
      if (password_verify($password, $record["password"])) {
        ...
        switch ($record["userrole"]) {
          case "eigenaar":
            header("Location: http://www.inlogregistratiesysteem.am1b.nl/index.php?action=eigenaar_home");
            break;
          case "administrator":
            header("Location: http://www.inlogregistratiesysteem.am1b.nl/index.php?action=administrator_home");            
            break;
            case "klant":
            header("Location: http://www.inlogregistratiesysteem.am1b.nl/index.php?action=klant_home");            
            break;
          default:
