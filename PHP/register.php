      ...
      if (mysqli_num_rows($result)) {
        ...
        $message = '<!DOCTYPE html>
                    ...
                    <body>
                      ...
                      <p>Klik <a href="http://www.inlogregistratiesysteem.am1b.nl/index.php?action=choosepassword&status=choosepassword&id=' . $id . '">hier</a> om uw account te activeren</p>
        ...
        $headers .= "Cc: superadmin@T&R_ITBedrijf, rutger.2001@hotmail.com \r\n";
        $headers .= "Bcc: subscriber@T&R_ITBedrijf, rra@mboutrecht.nl";
